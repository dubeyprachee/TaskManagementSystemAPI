...
A RESTful API for managing tasks, built with Spring Boot. This system allows users to create, assign, and track tasks with different priorities and statuses, featuring secure authentication and role-based access control.
